      ...
      <div className="citadel-container flex h-[var(--citadel-header-height)] items-center justify-between gap-4">
        ...
        <div className="hidden md:flex flex-1 max-w-md">
          <div className="relative w-full">
            ...
            />
            <kbd className="absolute right-3 top-1/2 -translate-y-1/2 rounded px-1.5 py-0.5 text-2xs bg-surface-2 border border-line-subtle text-ink-muted">Ctrl+K</kbd>
          </div>
        </div>
